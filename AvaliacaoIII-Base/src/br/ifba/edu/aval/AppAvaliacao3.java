...
import br.ifba.edu.aval3.CoR.RegraChegadaRegistradaHandler;
import br.ifba.edu.aval3.CoR.RegraOrdemPrismasHandler;
import br.ifba.edu.aval3.CoR.RegraPenalidadeAtrasoHandler;
import br.ifba.edu.aval3.CoR.RegraTempoMaximoHandler;
import br.ifba.edu.aval3.CoR.RegraTodosPrismasHandler;
...
public class AppAvaliacao3 extends AppAvaliacaoBase{
	...
	public AppAvaliacao3() {
		this.cadeiaDeRegras = new RegraChegadaRegistradaHandler(
                new RegraTempoMaximoHandler(
                    new RegraOrdemPrismasHandler(
                        new RegraTodosPrismasHandler(
                            new RegraPenalidadeAtrasoHandler(null) 
                        )
                    )
                )
            );
		this.apurador = new Apurador(Duration.ofMinutes(120), this.cadeiaDeRegras);
	}
